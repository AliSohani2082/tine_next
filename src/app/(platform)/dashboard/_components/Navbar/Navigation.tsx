    ...
    items: [
      {
        ...
        description: "گراف همکاری برای مشاهده گروه های همکاری از آیتم های دیتابیس را مشاهده میکنید.",
      },
      {
        title: "گراف همرخدادی",
      ...
      },
      {
        ...
        description: "گراف پیوندکتابشناختی برای مشاهده گراف همکاری از آیتم های دیتابیس را مشاهده می"
      },
      {
        title: "گراف هم ارجاعی",
        href: "referential_graph",
        description: "گراف هم ارجاعی برای مشاهده گروه های ه ارجاعی از آیتم های دیتابیس را مشاهده میکنید"
      },
      {
        title: "گراف ارجاعات",
        href: "referral_graph",
        description: "گراف ارجاعات برای مشاهده گروه های اارجاعات از آیتم های دیتابیس را مشاهده میکنید"
      },
    ]
  },
  {
    title: "اطلاعات جامع",
    href: "",
    description: "اطلاعات جامع برای مشاهده اطلاعات جاممع از آیتم های دیتابیس را مشاهده میکنید"
  },
]
          ...
          if ('items' in component) {
                ...
                <NavigationMenuContent>
                  <ul className="grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">    
                    {component.items.map((item, index) => (
                      <ListItem href={`/dashboard/database/${databaseId}/${item.href}`} title={item.title} key={index}>
                        {item.description}
                      </ListItem>
                    ))}
                  </ul>
            ...
            return (
              <NavigationMenuItem key={index}>
                <Link href={`/dashboard/database/${databaseId}/${component.href}`} legacyBehavior passHref>
