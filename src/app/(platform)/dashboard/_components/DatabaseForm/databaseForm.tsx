...
import { Query, CreateDatabase as createDatabaseValidation } from "@/lib/validation";
...
const DatabaseForm = () => {
  ...
  const onSubmitCreate = async (values: z.infer<typeof createDatabaseValidation>) => {
    console.log(values);
  };
      ...
      steps={[
        {
          ...
          isOptional: false,
          content: <InformationForm ref={createFormRef} onSubmit={onSubmitCreate} />,
          onSubmit: () => {
        ...
        },
        {
          ...
          description: "idk...",
          isOptional: false,
          content: <Finder ref={finderRef} onSubmit={onSubmitFinder} onScan={onScan} progress={progress} setProgress={setProgress} />,
          onSubmit: () => {
            console.log("step2");
          },
          additionalActions: [
